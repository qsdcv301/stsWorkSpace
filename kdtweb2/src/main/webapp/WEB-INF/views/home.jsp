...
<script src="${pageContext.request.contextPath}/resources/js/photo-gallery.js"></script>
    <div class="row">
          <div class="col-6">
            <div class="comu-box">
               <h2>Our Gallery</h2>
               <div class="photos-gallery clearfix">
                <!--loop -->
                   <div class="picture">
                      <a href="#"><img src="${pageContext.request.contextPath}/resources/images/upload/001.jpg" alt="001">
                         <div class="txt-box">제목1입니다.제목4입니다.</div>
                      </a>
                   </div>
                   <div class="picture">
                      <a href="#"><img src="${pageContext.request.contextPath}/resources/images/upload/002.jpg" alt="002">
                        <div class="txt-box">제목2입니다.제목4입니다.</div>
                      </a>
                    </div>
                   <div class="picture">
                      <a href="#"><img src="${pageContext.request.contextPath}/resources/images/upload/003.jpg" alt="003">
                        <div class="txt-box">제목3입니다.제목4입니다.</div>
                      </a>
                   </div>
                   <div class="picture">
                      <a href="#"><img src="${pageContext.request.contextPath}/resources/images/upload/004.jpg" alt="004">
            ...
            <div class="comu-box">
               ...
               <ul class="blogul">
                  <li>
                     <a href="#" class="blogs">
                        <div class="thumb">
                           <img src="${pageContext.request.contextPath}/resources/images/upload/006.webp" alt="006" />
                        </div>
                        <div class="blog-text">
                           <h3>기사의 제목을 넣음</h3>
          ...
          <div class="col-6">
            <div class="comu-box">
               <h2><a href="bbs">Community</a></h2>
               <ul class="noticeul">
                 <c:forEach var="list" items="${bbsList }"> 
                  <li>
                     <a href="bbs?mode=view&num=${list.num }">
                        ${list.title }
                     </a>
