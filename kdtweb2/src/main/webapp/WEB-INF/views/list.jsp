   ...
   <tbody>
      <c:forEach var="post" items="${boardList}">
         <tr>
            ...
            <td class="ellipsis"><a href="?mode=view&num=${post.num}&pg=${paging.currentPage}">${post.title}</a></td>
...
<div class="search-and-button">
   <div class="col-md-5 searchbox">
      <form id="searchForm" name="searchForm" method="get">
         <div class="input-group mt-3 mb-3">
            ...
            <input type="hidden" id="searchKey" name="searchKey" value="${encodeSearchKey}">
   ...
   <div class="col-md-7 text-right">
      <a href="?mode=list" class="btn btn-success">목록</a>  
