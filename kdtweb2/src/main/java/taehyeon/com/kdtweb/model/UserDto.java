package taehyeon.com.kdtweb.model;
...
public class UserDto {
	...
	public UserDto(int id, String userid, String userpass, String username, String useremail, String usertel, int userpost,
			String useraddr1, String useraddr2, String useraddrexc, Timestamp rdate, int grade) {
		super();
		this.id = id;
		this.userid = userid;
