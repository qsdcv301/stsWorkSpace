...
<h1 class="text-center my-5">등록하기</h1>
<form name="update_form" id="update_form" class="row was-valited" method="post" action="/edit">
   <div class="col-md-6 my-3">
      <div class="row align-items-center">
         <label for="writer" class="w-label">이름</label>
         <input type="text" class="form-control" name="writer" id="writer" 
         value="${boardView.writer }" required />
      </div>
   </div>
   ...
   <div class="col-md-6 my-3">
      <div class="row align-items-center">
         ...
         <input type="password" class="form-control" name="password" id="password"
          value="${boardView.password }" required />
      </div>
   </div>
   </c:when>
   ...
   <div class="col-md-12 my-3">
      <div class="row align-items-center">
         ...
         <input type="text" class="form-control" name="title" id="title" 
          value="${boardView.title }" required />
      </div>
   </div>
    <div class="col-md-12 my-3">
      <div class="row align-items-center">
