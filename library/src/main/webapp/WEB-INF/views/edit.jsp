...
<div class="bg-white bbs">
    ...
    <h1 class="text-center my-5">수정하기</h1>
    <form name="write_form" id="write_form" class="row was-valited" method="post" action="edit">
        <div class="col-md-6 my-3">
            <div class="row align-items-center">
                <label for="title" class="w-label">제목</label>
                <input type="text" class="form-control" name="title" id="title" required value="${boardView.title}"/>
            </div>
        </div>
        <div class="col-md-6 my-3">
            <div class="row align-items-center">
                <label for="writer" class="w-label">작가</label>
                <input type="text" class="form-control" name="writer" id="writer" required value="${boardView.writer}"/>
            </div>
        </div>
        <div class="col-md-6 my-3">
            <div class="row align-items-center">
                <label for="isbn" class="w-label">ISBN</label>
                <input type="text" class="form-control" name="isbn" id="isbn" required value="${boardView.isbn}"/>
            </div>
        </div>
        <div class="col-md-6 my-3">
            <div class="row align-items-center">
                <label for="publication" class="w-label">출판날짜</label>
                <input type="text" class="form-control" name="publication" id="publication" required value="${boardView.publication}"/>
            </div>
        </div>
